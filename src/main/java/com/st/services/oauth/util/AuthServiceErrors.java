...
public class AuthServiceErrors {
	...
	public static final AuthError NO_ACCESS_TOKEN = new AuthError("130", "No Access Token - Access Not enabled");

	public static final AuthError ACCESS_TOKEN_EXPIRED = new AuthError("140", "Access Token Expired - ReEnable Access");

	public static final AuthError REFRESH_TOKEN_EXPIRED = new AuthError("140", "Refresh Token Expired - ReEnable Access");

	public static final AuthError REFRESH_ACCESS_FAILED = new AuthError("150", "Refresh Access Token call failed - ReEnable Access");
